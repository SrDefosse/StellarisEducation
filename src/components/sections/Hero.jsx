    ...
    <div className="relative w-full min-h-screen">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="text-center text-white max-w-3xl px-4">
          ...
          <p className="text-xl md:text-2xl mb-10">TStellaris provides Pre-K programs for ages 3-5 in a nurturing environment where children develop a global perspective through language immersion and the International Baccalaureate program.</p>
