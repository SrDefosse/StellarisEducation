      ...
      <MaxWidthWrapper>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="rounded-2xl overflow-hidden shadow-xl aspect-video relative">
            <div className="absolute inset-0 bg-indigo-900/20 flex items-center justify-center group cursor-pointer hover:bg-indigo-900/10 transition-colors duration-300">
              <motion.div 
            ...
            <video 
              poster="/stellaris-thumbnail.jpg" 
              className="w-full h-full object-cover"
            >
              <source src="/stellaris-day.mp4" type="video/mp4" />
          ...
          <div className="flex flex-col space-y-6">
            ...
            >
              <a href="#" className="text-[#4081DE] font-medium flex items-center justify-end gap-2 group">
